...
class NeRFDataset:
    def __init__(self, opt, root_path, save_dir, feat_dir, device, num_train_frames=300, type='train', downscale=1, n_test=10, triplane_resolution=512, triplane_channels=32, face=False):
        super().__init__()
