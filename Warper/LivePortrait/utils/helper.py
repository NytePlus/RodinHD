...
def load_model(ckpt_path, model_config, device, model_type):
    ...
    modified_layers = model_config['modified_layers'][model_type]
    freeze_layers = model_config['freeze_layers'][model_type]
