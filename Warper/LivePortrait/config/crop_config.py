...
class CropConfig(PrintableConfig):
    insightface_root: str = make_abs_path("../../weights/insightface")
    landmark_ckpt_path: str = make_abs_path("../../weights/liveportrait/landmark.onnx")
    ...
    xpose_ckpt_path: str = make_abs_path("../../weights/liveportrait_animals/xpose.pth")
