...
triplane_path=/home/wcc/RodinHD/data/triplane_128
...
CUDA_VISIBLE_DEVICES=1,4 mpiexec -n $NUM_GPUS python base_train.py $MODEL_FLAGS $TRAIN_FLAGS $SAMPLE_FLAGS $DIFFUSION_FLAGS $DATASET_FLAGS
