NUM_GPUS=2
output_path=/home/wcc/RodinHD/data/warper_diffusion
txt_file=/home/wcc/RodinHD/data/triplane_128_2/fitting_obj_list.txt
triplane_path=/home/wcc/RodinHD/data/triplane_128_2
source_triplane_path=/home/wcc/RodinHD/data/save_triplane_and_mlp256
target_triplane_path=/home/wcc/RodinHD/data/save_triplane256
latent_root=/home/wcc/RodinHD/data/emo_feature/latent
...
DATASET_FLAGS="--data_dir $triplane_path --source_dir $source_triplane_path --target_dir $target_triplane_path --start_idx 0 --end_idx $num_samples  --mode triplane --txt_file $txt_file --latent_root $latent_root --ms_feature_root $ms_feature_root"
