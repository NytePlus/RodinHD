output_path=/home/wcc/RodinHD/data/save_updiffusion4
txt_file=/home/wcc/RodinHD/data/save_triplane_and_mlp4/fitting_obj_list.txt
hr_triplane_path=/home/wcc/RodinHD/data/save_triplane_and_mlp2
image_root=/home/wcc/RodinHD/data/portrait3d_data
render_ckpt=/home/wcc/RodinHD/data/save_triplane_and_mlp4/checkpoints/ngp_ep0017.pth.pth
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4 deepspeed upsample_train.py $MODEL_FLAGS  $TRAIN_FLAGS $SAMPLE_FLAGS $DIFFUSION_FLAGS  $DATASET_FLAGS $DEEPSPEED_FLAGS 
