...
cd ..
cd Renderer
python main.py $txt_file  $output_path/LR  --workspace $output_path/render_lr --data_root $render_cam_path -O --start_idx 0 --end_idx $num_samples --bound 0.9 --scale 2 --dt_gamma 0 --ckpt $render_ckpt  --iters 15000 --lr1 0 --test --dataset metahuman 
